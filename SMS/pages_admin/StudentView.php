                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        {
                                            $class_name_sql = "SELECT * FROM class WHERE classID='".$row['classID']."';";
                                            $class_name = $conn->query($class_name_sql);
                                            $class_name_row = $class_name->fetch_assoc();
                                            $yeargrade=$class_name_row['yearGrade'];
                                            ...
                                            echo 
                                                '<tr>
                                                            ...
                                                            <td>
                                                            <a href="StudentGradesView.php?id='.$row['studentID'].'&firstname='.$row['firstName'].'&lastname='.$row['lastName'].'&yeargrade='.$yeargrade.'" title="Student Grade"title="Update Student" data-toggle="tooltip" class="icon"><i class="fas fa-eye"></i></a>&nbsp;';

                                            if($row['classID'] == ''){
                                                echo '
                                                            <a href="StudentRegister.php?id='.$row['studentID'].'&firstname='.$row['firstName'].'&lastname='.$row['lastName'].'" title="Register Student" data-toggle="tooltip" class="icon"><i class="fas fa-lock"></i></a>';
                                            }
                                            echo'
                                                            </td>
															</tr>';
