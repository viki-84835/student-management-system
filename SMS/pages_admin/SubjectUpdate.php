                                            ...
                                            <form class="forms-sample" method="post" action="#">
                                                ...
                                                if (isset($_POST['Update'])){ 
                                                    ...
                                                    if ($result = $conn->query($sql)) {
                                                        ...
                                                        echo "<script> alert('Subject Updated Successfully!'); location.href='index.php'; </script>";
                                                    } 
                                                    else {
                                                ...
                                                if (isset($_POST['Delete'])){ 
                                                    ...
                                                    if ($result = $conn->query($dsql)) {
                                                        ...
                                                        echo "<script> alert('Subject Deleted Successfully!'); location.href='index.php'; </script>";
                                                    } 
                                                    else {
                                                        $errMSG = mysqli_error($conn);
                                                    }	
