                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="page-header clearfix">
                                                <h2 style="float:left">Filter Teacher</h2>				
                                            </div>
                                            <form class="forms-sample" method="post">
                                                <div class="row">
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                                                            <input type="text" class="form-control" placeholder="Teacher ID" name="studentID">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-lg-12 grid-margin stretch-card">
                            <div class="card">
                                <div class="card-body">
                                    <div class="page-header clearfix">
                                        <h2 style="float:left">Teacher Details</h2>
                                        <a href="TeacherAdd.php" class="btn btn-dark pull-right" style="float: right">Add New Teacher</a>
                                    </div>
                                    <?php 
                                    ...
                                    if (isset($_POST['search'])){ 
                                        ...
                                        if (!empty($_POST["studentID"])) 
                                            $where .= "TeacherID LIKE '%{$_POST["studentID"]}%' "; 
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        {
                                            $class_name_sql = "SELECT * FROM subject WHERE subjectID='".$row['subjectID']."';";
                                            ...
                                            echo 
                                                '<tr>
															...
															<td>'.$row['gender'].'</td>
                                                            <td>'.$class_name_row['subjectName'].'</td>

                                                            <td>
                                                            <a href="updateteacher.php?id='.$row['TeacherID'].'"title="Update" data-toggle="tooltip" class="icon"><i class="fas fa-pen"></i></a>&nbsp;';
                                            echo'
                                                            </td>
															</tr>';
                                        }
